...
* **Ubicación de Inteligencia:** El núcleo de configuración de agentes reside en la carpeta `.agents`.
* **Definiciones de Agentes:** Todas las personalidades, protocolos de comunicación y habilidades específicas están documentadas en archivos `.md` dentro de `.agents`.
...
* **Mantenimiento:** Cualquier actualización en la lógica de operación o nuevas habilidades adquiridas debe ser documentada en el archivo correspondiente dentro de `./agents`.